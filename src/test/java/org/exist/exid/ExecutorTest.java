...
public class ExecutorTest {
    ...
    public void testName() throws Exception {
        Sequence result = eval("let $a := 'a' return exid:submit(xmldb:store('/db', 'test.xml', <a>{upper-case($a)}</a>))");
    ...
    public static void setUpBeforeClass() throws Exception {
        ...
        builtInModules.put(
                org.exist.exid.Module.NAMESPACE_URI,
                org.exist.exid.Module.class);
    }
